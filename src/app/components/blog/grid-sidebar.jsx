                      ...
                      <div className="mt-post-meta bdr-1 bdr-solid bdr-b-1 bdr-gray-light p-b20">
                        <ul>
                          <li className="post-date">
                            {" "}
                            <i className="fa fa-calendar site-text-primary" />
                            <strong>14</strong> <span>Dec 2023</span>{" "}
                          </li>
                          <li className="post-author">
                            <i className="fa fa-user site-text-primary" />
                            <NavLink to={route.pages.team.DETAIL}>
                      ...
                      <div className="mt-post-meta bdr-1 bdr-solid bdr-b-1 bdr-gray-light p-b20">
                        <ul>
                          <li className="post-date">
                            {" "}
                            <i className="fa fa-calendar site-text-primary" />
                            <strong>16</strong> <span>Dec 2023</span>{" "}
                          </li>
                          <li className="post-author">
                            <i className="fa fa-user site-text-primary" />
                            <NavLink to={route.pages.team.DETAIL}>
                      ...
                      <div className="mt-post-meta bdr-1 bdr-solid bdr-b-1 bdr-gray-light p-b20">
                        <ul>
                          <li className="post-date">
                            {" "}
                            <i className="fa fa-calendar site-text-primary" />
                            <strong>18</strong> <span>Dec 2023</span>{" "}
                          </li>
                          <li className="post-author">
                            <i className="fa fa-user site-text-primary" />
                            <NavLink to={route.pages.team.DETAIL}>
                      ...
                      <div className="mt-post-meta bdr-1 bdr-solid bdr-b-1 bdr-gray-light p-b20">
                        <ul>
                          <li className="post-date">
                            {" "}
                            <i className="fa fa-calendar site-text-primary" />
                            <strong>20</strong> <span>Dec 2023</span>{" "}
                          </li>
                          <li className="post-author">
                            <i className="fa fa-user site-text-primary" />
                            <NavLink to={route.pages.team.DETAIL}>
