          ...
          <div className="row">
            ...
            <div className="col-lg-8 col-md-12 m-b30">
              ...
              <div className="blog-post blog-lg date-style-2">
                <div className="mt-post-media mt-img-effect">
                  <NavLink to={route.blog.POST_SINGLE}>
                    <FastImage src="images/blog/default/thum4.jpg" alt="" />
                  </NavLink>
                </div>
                <div className="mt-post-info p-m30 p-tb30 ">
                  ...
                  <div className="mt-post-title">
                    <h3 className="post-title">
                      <NavLink to={route.blog.POST_SINGLE}>
                        Logistics through innovation, dedication, and
                        technology.
                      </NavLink>
                    </h3>
                  </div>
                  <div className="mt-post-text">
                    <p>
                      Lorem Ipsum has been the industry's standard. Asperiores,
                      tenetur, blanditiis, quaerat odit exercitationem pariatur
                      quibusdam veritatis quisquam laboriosam.
                    </p>
                  </div>
                  <div className="mt-post-readmore m-b0">
                    <NavLink
                      to={route.blog.POST_SINGLE}
                      title="READ MORE"
                      rel="bookmark"
              ...
              <div className="blog-post blog-lg date-style-2">
                <div className="mt-post-media mt-img-effect">
                  <NavLink to={route.blog.POST_SINGLE}>
                    <FastImage src="images/blog/default/thum5.jpg" alt="" />
                  </NavLink>
                </div>
                <div className="mt-post-info p-m30 p-tb30 ">
                  <div className="mt-post-meta bdr-1 bdr-solid bdr-b-1 bdr-gray-light p-b20">
              ...
              <div className="blog-post blog-lg date-style-2">
                <div className="mt-post-media mt-img-effect">
                  <NavLink to={route.blog.POST_SINGLE}>
                    <FastImage src="images/blog/default/thum6.jpg" alt="" />
                  </NavLink>
                </div>
                <div className="mt-post-info p-m30 p-tb30 ">
                  <div className="mt-post-meta bdr-1 bdr-solid bdr-b-1 bdr-gray-light p-b20">
