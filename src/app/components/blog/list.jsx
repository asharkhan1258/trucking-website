          ...
          <div className="blog-post blog-md date-style-2 clearfix bdr-1 bg-white">
            <div className="mt-post-media">
              <NavLink to={route.blog.POST_SINGLE}>
                <FastImage src="images/blog/grid/pic4.jpg" alt="" />
              </NavLink>
            </div>
            <div className="mt-post-info p-m30 p-a30 overflow-hide">
              <div className="mt-post-meta">
                <ul>
                  ...
                  <li className="post-comment">
                    ...
                    <NavLink to={route.blog.POST_SINGLE}>0 Comments</NavLink>{" "}
                  </li>
                </ul>
              </div>
              <div className="mt-post-title">
                <h3 className="post-title">
                  <NavLink to={route.blog.POST_SINGLE}>
                    Go beyond logistics, make the world go round and revolution.
                  </NavLink>
                </h3>
              </div>
              <div className="mt-post-text">
                <p>
                  ...
                  standard. Asperiores, tenetur, blanditiis, quaerat odit ex
              ...
              <div className="mt-post-meta">
                <ul>
                  <li className="post-date">
                    {" "}
                    <i className="fa fa-calendar site-text-primary" />
                    <strong>12</strong> <span>Nov 2023</span>{" "}
                  </li>
                  <li className="post-author">
                    <i className="fa fa-user site-text-primary" />
                    <NavLink to={route.pages.team.DETAIL}>
              ...
              <div className="mt-post-meta">
                <ul>
                  <li className="post-date">
                    {" "}
                    <i className="fa fa-calendar site-text-primary" />
                    <strong>15</strong> <span>Dec 2023</span>{" "}
                  </li>
                  <li className="post-author">
                    <i className="fa fa-user site-text-primary" />
                    <NavLink to={route.pages.team.DETAIL}>
