        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-8 col-md-12 m-b30">
              ...
              <div className="blog-post date-style-2 blog-post-single">
                ...
                <div className="post-description-area p-t30">
                  <div className="mt-post-meta bdr-1 bdr-solid bdr-b-1 bdr-gray-light p-b20">
                    <ul>
                      ...
                      <li className="post-comment">
                        ...
                        <NavLink to={route.pages.ABOUT}>0 Comments</NavLink>{" "}
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="mt-post-text">
                    <p>
                      Lorem Ipsum is simply text of the. Lorem Ipsum is simply
                      text of the stry stext of the stry simply dummy text of
                      the printing and typesetting industry. Lorem Ipsum is
                      simply text of the. Lorem Ipsum is simply text of the stry
                    ...
                    <p>
                      ...
                      was popularised in the 1960s with Letraset.
                    </p>
                    <blockquote className="bdr-3 bdr-primary bdr-2 bdr-l-2 bdr-primary">
                      Mauris fermentum porta sem, non hendrerit enim bibendum
                      consectetur. Fusce diam est, porttitor vehicula gravida
                      at, accumsan bibendum tincidunt imperdiet. Maecenas quis
                      magna faucibus, varius ante sit amet, varius augue.
                      Praesent aliquam, augue ac pulvinar accumsan
                      <div className="p-t15">
                        <p> – Jone Due</p>
                      </div>
                    </blockquote>
                    <p>
                      ...
                      adipisicing elit. Accusantium vitae, consequuntur minima
                      tempora ins cupiditate ratione est, ad molestias deserunt
                      in ipsam ea quasi cum culpa adipisci dolores voluptatum
                      fuga at! assumenda provident lorem ipsum dolor sit amet,
                      consectetur.
                    </p>
                    <div className="row">
                      <div className="col-lg-6 col-md-12 col-sm12">
                        <div className="mt-box ">
                          <div className="mt-thum-bx mt-img-effect overflow-hide m-b20">
                            <FastImage
                              src="images/blog/blog-small/pic2.jpg"
                              alt=""
                            />
                          </div>
                        </div>
                    ...
                    <p>
                      ...
                      tincidunt erat. Etiam purus sem, euismod eu vulputate
                      eget, porta quis sapien. Donec tellus est, rhoncus vel
                      scelerisque id, iaculis eu nibh.
                    </p>
                  </div>
              ...
              <div
                className="clear bg-gray p-a30 comment-list-bg radius-10"
                id="comment-list"
              >
                <div className="comments-area" id="comments">
                  ...
                  <div className="p-t30">
                    ...
                    <ol className="comment-list">
                      <li className="comment">
                        ...
                        <div className="comment-body bg-white">
                          <div className="comment-meta">
                            <p style={{ color: "#ff5e14", cursor: "default" }}>
                              Sep 11, 2023 at 7:15 am
                            </p>
                          </div>
                          <div className="comment-author vcard">
                            <FastImage
                              className="avatar photo"
                              src="images/user/pic1.jpg"
                              alt=""
                            />
                      ...
                      <li className="comment">
                        ...
                        <div className="comment-body  bg-white">
                          <div className="comment-meta">
                            <p style={{ color: "#ff5e14", cursor: "default" }}>
                              Sep 11, 2023 at 8:30 am
                            </p>
                          </div>
                          <div className="comment-author vcard">
                            <FastImage
                              className="avatar photo"
                              src="images/user/pic2.jpg"
                              alt=""
                            />
                          ...
                          <p>
                            Duis sed odio http://themeforest.net Morbi accumsan
                          ...
                          <li className="comment odd parent">
                            <div className="comment-body bg-white">
                              <div className="comment-meta">
                                ...
                                >
                                  Sep 11, 2023 at 9:00 am
                                </p>
                              </div>
                              <div className="comment-author vcard">
                                <FastImage
                                  className="avatar photo"
                                  src="images/user/pic3.jpg"
                                  alt=""
                                />
                              ...
                              <p>
                                laboriosam esse beatae hic perferendis velit
                                deserunt soluta iste repellendus officia in
                                neque veniam debitis
                              </p>
                              <div className="reply">
                                <button className="comment-reply-link">
                                  Reply
                              ...
                              <li className="comment odd parent">
                                <div className="comment-body bg-white">
                                  <div className="comment-meta">
                                    ...
                                    >
                                      Sep 11, 2023 at 11:15 am
                                    </p>
                                  </div>
                                  <div className="comment-author vcard">
                                    <FastImage
                                      className="avatar photo"
                                      src="images/user/pic4.jpg"
                                      alt=""
                                    />
                                    <cite className="fn">Mila Curtis</cite>
                                    <span className="says">says:</span>
                                  ...
                                  <p>
                                    Lorem ipsum dolor sit amet of Lorem Ipsum.
                                    Proin gravida nibh..
                                  </p>
                                  <div className="reply">
                                    <button className="comment-reply-link">
                      ...
                      <li className="comment">
                        ...
                        <div className="comment-body bg-white">
                          ...
                          <p>
                            Quisquam laboriosam esse beatae hic perferendis
                            velit deserunt soluta iste repellendus officia in
                            neque veniam debitis
                          </p>
                          <div className="reply">
                            <button className="comment-reply-link">
                    ...
                    {/* LEAVE A REPLY START */}
                    <div
                      className="comment-respond  bg-white p-a30"
                      id="respond"
                    >
