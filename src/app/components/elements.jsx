...
function ElementsPage() {
  ...
  return (
    <>
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-6 m-b50">
              ...
              <div className="section-content">
                <div
                  className="accordion mt-accordion acc-default"
                  id="accordionExample"
                >
                  {/*one*/}
                  <div className="acod-head mt-panel">
                    <h6
                      className="accordion-header acod-title text-uppercase bdr-solid bdr-l-2 p-l10 bdr-primary"
                      id="headingOne-1"
                    >
                      <button
                        style={{
                    ...
                    >
                      <div className="acod-body">
                        <div className="acod-content p-tb15">
                          ...
                          ourselves. This is why I find them so interesting and
                          crucial on our paths to success.
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="m-b30">
              <div className="row">
                ...
                <div className="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-xs-100pc">
                  <div className="m-b30 text-black text-center bdr-1 bdr-solid bdr-gray p-a20 radius-10">
                    <div className="icon-lg m-b20">
                      <i className="fa fa-truck site-text-primary" />
                    </div>
                    <div className="font-26 font-weight-800 m-b5">
                ...
                <div className="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-xs-100pc">
                  <div className="m-b30  text-black text-center bdr-1 bdr-solid bdr-gray p-a20 radius-10">
                    <div className="icon-lg m-b20">
                      <i className="fa fa-stack-overflow site-text-primary" />
                    </div>
                    <div className="counter font-26 font-weight-800 m-b5">
                ...
                <div className="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-xs-100pc">
                  <div className="m-b30 text-black text-center bdr-1 bdr-solid bdr-gray p-a20 radius-10">
                    <div className="icon-lg m-b20">
                      <i className="fa fa-paper-plane site-text-primary" />
                    </div>
                    <div className="counter font-26 font-weight-800 m-b5">
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-6 m-b30">
              ...
              <div className="section-content">
                <div
                  className="accordion mt-accordion acc-outline"
                  id="accordion3"
                >
                  {/*one*/}
                  <div className="acod-head mt-panel">
                    <h6
                      className="accordion-header acod-title text-uppercase corner-skew"
                      id="headingOne-tgl31"
                    >
                      <button
                        style={{
                        ...
                        data-bs-toggle="collapse"
                        data-bs-target="#collapseOne-tgl-1"
                        aria-expanded="false"
                        aria-controls="collapseOne-tgl-1"
                      >
                        <p
                          className="mb-0"
                          style={{ width: "fit-content", fontSize: "15px" }}
                    ...
                    <div
                      id="collapseOne-tgl-1"
                      className="accordion-collapse collapse"
                      aria-labelledby="headingOne-tgl31"
                    >
                      <div className="acod-body">
                        <div className="acod-content p-tb15">
                          The leap into electronic typesetting, remaining
                  ...
                  <div className="acod-head mt-panel">
                    ...
                    >
                      <button
                        ...
                        data-bs-toggle="collapse"
                        data-bs-target="#collapseTwo-tgl-1"
                        aria-expanded="false"
                        aria-controls="collapseTwo-tgl-1"
                      >
                        <p
                          className="mb-0"
                          style={{ width: "fit-content", fontSize: "15px" }}
                    ...
                    <div
                      id="collapseTwo-tgl-1"
                      className="accordion-collapse collapse"
                      aria-labelledby="headingTwo-tgl32"
                    >
                      <div className="acod-body">
                        <div className="acod-content p-tb15">
                          Inspirational quotes have an amazing ability to
                  ...
                  <div className="acod-head mt-panel">
                    ...
                    >
                      <button
                        ...
                        data-bs-toggle="collapse"
                        data-bs-target="#collapseThree-tgl-1"
                        aria-expanded="false"
                        aria-controls="collapseThree-tgl-1"
                      >
                        <p
                          className="mb-0"
                          style={{ width: "fit-content", fontSize: "15px" }}
                    ...
                    <div
                      id="collapseThree-tgl-1"
                      className="accordion-collapse collapse"
                      aria-labelledby="headingThree-tgl33"
                    >
                      <div className="acod-body">
                        <div className="acod-content p-tb15">
                          Inspirational quotes have an amazing ability to
                  ...
                  <div className="acod-head mt-panel">
                    ...
                    >
                      <button
                        ...
                        data-bs-toggle="collapse"
                        data-bs-target="#collapseOne-tgl-2"
                        aria-expanded="false"
                        aria-controls="collapseOne-tgl-1"
                      >
                        <div style={{ width: "fit-content" }}>
                    ...
                    <div
                      id="collapseOne-tgl-2"
                      className="accordion-collapse collapse"
                      aria-labelledby="headingOne-tgl3"
                    >
                      <div className="acod-body">
                        <div className="acod-content p-tb15">
                          The leap into electronic typesetting, remaining
                  ...
                  <div className="acod-head mt-panel">
                    ...
                    >
                      <button
                        ...
                        data-bs-toggle="collapse"
                        data-bs-target="#collapseTwo-tgl-2"
                        aria-expanded="false"
                        aria-controls="collapseTwo-tgl-1"
                      >
                        <div style={{ width: "fit-content" }}>
                    ...
                    <div
                      id="collapseTwo-tgl-2"
                      className="accordion-collapse collapse"
                      aria-labelledby="headingTwo-tgl3"
                    >
                      <div className="acod-body">
                        <div className="acod-content p-tb15">
                          Inspirational quotes have an amazing ability to
                  ...
                  <div className="acod-head mt-panel">
                    ...
                    >
                      <button
                        ...
                        data-bs-toggle="collapse"
                        data-bs-target="#collapseThree-tgl-2"
                        aria-expanded="false"
                        aria-controls="collapseThree-tgl-1"
                      >
                        <div style={{ width: "fit-content" }}>
                    ...
                    <div
                      id="collapseThree-tgl-2"
                      className="accordion-collapse collapse"
                      aria-labelledby="headingThree-tgl3"
                    >
                      <div className="acod-body">
                        <div className="acod-content p-tb15">
                          Inspirational quotes have an amazing ability to
          ...
          <div className="section-content m-b30">
            <div className="mt-tabs tabs-default">
              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  <p className="m-b0">
                    Home lorem ipsum dolor sit amet, consectetuer adipiscing
                    elit. Suspendisse et justo. Praesent mattis commyolk augue
                    Aliquam ornare hendrerit augue Cras tellus In pulvinar
                    lectus a est Curabitur eget orci Cras laoreet. Lorem ipsum
                    dolor sit amet, consectetuer dolor sit amet
                  </p>
                </div>
                <div
                ...
                >
                  <p className="m-b0">
                    About Us lorem ipsum dolor sit amet, consectetuer adipiscing
                ...
                >
                  <p className="m-b0">
                    contact us lorem ipsum dolor sit amet, consectetuer
                    adipiscing elit.Commyolk Suspendisse et justo. Praesent
                    mattis augue Aliquam ornare hendrerit augue Cras tellus In
                    pulvinar lectus a est Curabitur eget orci Cras laoreet.
                    Lorem ipsum dolor sit amet, consectetuer doler sit amet
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="mt-tabs vertical tabs-default">
                  ...
                  <div className="tab-content" id="myTabContent2">
                    ...
                    >
                      <p className="m-b0">
                        Home lorem ipsum dolor sit amet, consectetuer adipiscing
                        elit. Suspendisse et justo. Praesent mattis commyolk
                        augue Aliquam ornare hendrerit augue Cras tellus In
                        pulvinar lectus a est Curabitur eget orci Cras laoreet.
                    ...
                    >
                      <p className="m-b0">
                        About Us lorem ipsum dolor sit amet, consectetuer
                        adipiscing elit. There are many variations of passages
                    ...
                    >
                      <p className="m-b0">
                        contact us lorem ipsum dolor sit amet, consectetuer
                        adipiscing elit.Commyolk Suspendisse et justo. Praesent
                        mattis augue Aliquam ornare hendrerit augue Cras tellus
                        In pulvinar lectus a est Curabitur eget orci Cras
                        laoreet. Lorem ipsum dolor sit amet, consectetuer doler
                        sit amet
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="pricingtable-wrapper pricing-table-style-5 site-bg-white block-shadow">
                    <div className="pricingtable-inner">
                      ...
                      <div className="pricingtable-footer">
                        <NavLink
                          to={route.pages.ABOUT}
                          className="site-button text-uppercase m-t25"
                        >
                          Order Now
                        </NavLink>
                      </div>
      ...
      <div
        className="section-full overlay-wraper p-t80 p-b50 bg-cover site-bg-white"
        data-stellar-background-ratio="0.5"
        style={{
          backgroundImage: `url(${publicUrlFor("images/background/bg2.jpg")})`,
        }}
      >
              ...
              <div className="item">
                <div className="testimonial-2  clearfix site-bg-white">
                  ...
                  <div className="testimonial-text">
                    <strong className="testimonial-name text-uppercase">
                      Collis Ta'eed{" "}
                    </strong>
                    ...
                    <p>
                      {" "}
                      Excellent Customer support!.The template itself is very
                      extended. simply dummy text of the printing and industry.
                      Lorem Ipsum has been the ins industry's standard printing.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="testimonial-5 site-bg-white">
                  ...
                  <div className="testimonial-text clearfix">
                    ...
                    <div className="testimonial-detail clearfix">
                      ...
                      <span className="testimonial-position site-text-primary p-t10">
                        Manager
                      </span>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-md-4 col-sm-12 m-b30">
                  ...
                  <div className="mt-box">
                    <div className="mt-thum-bx mt-img-overlay1 mt-img-effect yt-thum-box">
                      <img
                        src="https://img.youtube.com/vi/jic28SCOuRo/0.jpg"
                        alt=""
                      />
                      <a
                        href="https://www.youtube.com/watch?v=jic28SCOuRo"
                ...
                <div className="col-md-12 col-sm-12 m-b30">
                  ...
                  <div className="mt-box">
                    <div className="mt-thum-bx mt-img-overlay1">
                      <img
                        src="https://i.vimeocdn.com/video/437933798_590x332.jpg"
                        alt=""
                      />
                      <a
