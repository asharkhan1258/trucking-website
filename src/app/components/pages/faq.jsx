          ...
          <div className="row">
            <div className="col-lg-8 col-md-12  m-b30">
              ...
              >
                  ...
                  >
                    <div className="acod-body">
                      <div className="acod-content p-tb15">
                        ...
                        compliant initiatives. Progressively monetize
                        client-centric outsourcing with excellent communities.
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="acod-head mt-panel">
                  <h4
                    className="accordion-header  acod-title"
                    id="headingThree"
                  >
                    <button
                      style={{
            ...
            <div className="col-lg 4 col-md-12 m-b30">
              <div className="mt-box p-a30 need-help bg-gray">
                ...
                <p>
                  Find answers to frequently asked questions about Bizipress,
